...
- Community freshness scan：最近一次全量只读扫描为 `2026-07-29 15:10 CST`；`upstream/main` 仍为 `87e6e37`（merged #445 GitHub Actions pins）。15:20 后本轮已按用户 exact confirmation 发布 #446 inline review，并 force-with-lease 更新本人 #429 branch；除此之外未发布 upstream 内容。
...
- #446 `Upgrade agent sandbox v0.5.3`：open、non-draft、head `822dc7b`。production alpha scheme/watch 与 beta reconcilers/builders mismatch 已用三类型 red test + 最小 wiring green tests 证明。用户确认后已发布 [review 4805118919](https://github.com/volcano-sh/agentcube/pull/446#pullrequestreview-4805118919) / [inline 3671892415](https://github.com/volcano-sh/agentcube/pull/446#discussion_r3671892415)，绑定 right-side `pkg/workloadmanager/sandbox_controller.go:46`，103 words。等待作者恢复工作或回复；不追评、不 `/lgtm`。
