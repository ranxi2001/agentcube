...
- Go/toolchain prerequisite #391 has merged and fork CI PR #4 for the #387 rebase path is fully green. Next for agent-sandbox: ask user whether to clean-update upstream PR #387 by porting local validation branch `rebase/pr387-on-go1264` back to `origin/feat/agent-sandbox-latest` and pushing with `--force-with-lease`. Do not push/update #387 before explicit confirmation. Copilot's Node action modernization suggestion remains a possible separate cleanup PR, not part of #391 or #387.
