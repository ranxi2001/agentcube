...
这个目录用于记录我在 AgentCube 项目实习期间每天的学习、调研、实验和问题。

记录方式以实习生视角为主：当天看了哪些文档，跑了哪些命令，理解了哪些概念，遇到哪些问题，以及第二天准备继续研究什么。
...
- [Day 13：Karmada 项目学习与 Kubernetes-native 控制面设计](day13-karmada-project-study.md)
- [Day 14：Kubernetes 环境与 AgentCube 测试计划](day14-kubernetes-environment-and-test-plan.md)
- [Day 15：上游 PR review 与 SnapStart 实现调研](day15-upstream-pr-review-and-snapstart-implementation.md)
- [Day 16：适配最新 agent-sandbox](day16-agent-sandbox-latest-adaptation.md)
- [Day 17：PR #387 Copilot review 与 CI triage](day17-pr387-copilot-review-and-ci-triage.md)
- [Day 18：agent-sandbox v0.5 前沿适配测试](day18-agent-sandbox-v05-forward-adaptation.md)
- [Day 19：PR #387 代码 review 答辩准备](day19-pr387-code-review-prep.md)
- [Day 20：AgentCube 项目二次梳理与 agent-sandbox v0.2/v0.3/v0.5 实现记录](day20-agent-sandbox-v02-v03-v05-wip-pr-implementations-and-project-study.md)
- [Day 21：OpenSandbox 与 Agent Substrate 源码调研](day21-opensandbox-agent-substrate-study.md)
- [Day 22：OpenSandbox / Agent Substrate 实测 runbook](day22-opensandbox-agent-substrate-runtime-runbook.md)
- [Day 23：AgentCube 未来发展方向与架构设计](day23-agentcube-future-architecture-and-design.md)
- [Day 24：Sandbox Sleep/Resume 设计笔记](day24-sandbox-sleep-resume-design-note.md)
- [Day 25：Sleep/Resume 代码审查与架构复盘](day25-sleep-resume-code-review-and-architecture-retrospective.md)
