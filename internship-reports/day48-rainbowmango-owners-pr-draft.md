...
This adds `RainbowMango` to the root reviewers and approvers, formalizing responsibilities already exercised across AgentCube. The examples below show how that work has shaped releases, proposals, and implementation quality:

- Organizes release and proposal work: created #386 as the v0.2.0 umbrella for proposal triage, ownership, and merge tracking; framed the long-term boundary between Kubernetes-owned resource pools and AgentCube-owned session lifecycle in #430 and opened it for community design work.
