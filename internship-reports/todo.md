...
| P0 | 适配最新 `kubernetes-sigs/agent-sandbox` | DOING | #386；PR [#387](https://github.com/volcano-sh/agentcube/pull/387) | 高 | 低 | 1-2 天 | [Day 16](day16-agent-sandbox-latest-adaptation.md) 已完成 `agent-sandbox v0.4.6` 适配、codegen 修复、k3s / SDK / MCP / math-agent 验证；commit `5316358` 已 push 并创建 upstream PR #387 | 跟踪 #387 的 CI、Codecov、golangci-lint、e2e、codegen check 和 maintainer review；获得 `lgtm` 后按 bot 提示 assign `hzxuzhonghu` approval |
