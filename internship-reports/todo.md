...
| P0 | 设计 docs/proposals 提案管理入口 | DONE | 不适用；fork branch `docs/proposals-management` | 中 | 低 | 0.5 天 | [Day 37](day37-docs-proposal-directory-management.md) 已调研 AgentCube 历史提案存放方式和 Karmada `docs/proposals` 结构；基于 `upstream/main f9c37d5` 创建分支 `docs/proposals-management`，commit `50116ca` 新增 `docs/proposals/README.md`、`docs/proposals/proposal-template.md` 并更新 `CONTRIBUTING.md` | 如要创建 upstream PR，先让用户确认 exact title/body/target；当前不移动历史 `docs/design` 文件，避免破坏链接 |
...
| 完成 docs/proposals 提案目录管理调研与分支准备 | [Day 37](day37-docs-proposal-directory-management.md) 已调研 Karmada proposal 目录和 AgentCube 历史设计存放方式，并在 fork 分支 `docs/proposals-management` 准备 `docs/proposals/README.md`、proposal template 和 CONTRIBUTING 更新 |
