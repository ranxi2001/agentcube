...
| P0 | 适配最新 `kubernetes-sigs/agent-sandbox` | DOING | #386；PR [#387](https://github.com/volcano-sh/agentcube/pull/387)；Go 前置 PR [#391](https://github.com/volcano-sh/agentcube/pull/391) 已合并 | 高 | 低 | 1-2 天 | [Day 16](day16-agent-sandbox-latest-adaptation.md) 已完成 `agent-sandbox v0.4.6` 适配、codegen 修复、k3s / SDK / MCP / math-agent 验证；[Day 17](day17-pr387-copilot-review-and-ci-triage.md) 已完成 Copilot/Gemini 评论分组和 CI triage；纯净 Go 1.26.4 前置 PR #391 已合并到 upstream `main`，merge commit `a31651e`；旧 Go 1.26.2 fork PR #2 已关闭为 superseded | 修复 #390 中 3 条有效 Gemini 评论后，将 #387 rebase 到包含 #391 的 upstream `main`，再 clean update #387 |
