...
| P0 | 项目二次梳理学习 | DONE | 不适用 | 中 | 低 | 0.5 天 | [Day 20](day20-project-second-pass-architecture-and-dependencies.md) 已完成：按 Router、WorkloadManager、Store、PicoD、agent-sandbox、codegen、auth、测试分层重新梳理当前 main 的真实实现，并明确设计文档中的 Sleep/Resume 与当前 delete-on-idle 实现差异 | 后续改代码前按 Day20 的阅读顺序和测试矩阵定位影响面 |
